...
describe("output_parser functional", function()
	local example_project_path = vim.fs.joinpath(debug.getinfo(1).source:match("@?(.*/)"), "example_project")
	...
	local tests_path = vim.fs.joinpath(example_project_path, "app", "src", "test", "kotlin", "org", "example")
	...
	local annotationspec_file = vim.fs.joinpath(tests_path, "KotestAnnotationSpec.kt")
	...
	nio.tests.it("functional test", function()
		...
		assert.equals("passed", results[describespec_file .. "::a namespace::should handle passed assertions"].status)
		assert.equals("failed", results[describespec_file .. "::a namespace::should handle failed assertions"].status)
		assert.equals("skipped", results[describespec_file .. "::a namespace::should handle skipped assertions"].status)
		assert.equals(
			"passed",
		...
		assert.equals("passed", results[funspec_file .. "::namespace::nested namespace::pass"].status)
		assert.equals("failed", results[funspec_file .. "::namespace::nested namespace::fail"].status)
		...
		assert.equals("passed", results[freespec_file .. "::namespace::pass"].status)
		assert.equals("failed", results[freespec_file .. "::namespace::fail"].status)
		assert.equals("passed", results[freespec_file .. "::namespace::nested namespace::pass"].status)
		assert.equals("failed", results[freespec_file .. "::namespace::nested namespace::fail"].status)
		...
		assert.equals("passed", results[featurespec_file .. "::namespace::pass"].status)
		assert.equals("failed", results[featurespec_file .. "::namespace::fail"].status)
		assert.equals("passed", results[featurespec_file .. "::namespace::nested namespace::pass"].status)
		assert.equals("failed", results[featurespec_file .. "::namespace::nested namespace::fail"].status)
		...
		assert.equals("passed", results[expectspec_file .. "::namespace::pass"].status)
		assert.equals("failed", results[expectspec_file .. "::namespace::fail"].status)
		assert.equals("passed", results[expectspec_file .. "::namespace::nested namespace::pass"].status)
		assert.equals("failed", results[expectspec_file .. "::namespace::nested namespace::fail"].status)
		...
		assert.equals("passed", results[shouldspec_file .. "::namespace::pass"].status)
		assert.equals("failed", results[shouldspec_file .. "::namespace::fail"].status)
		assert.equals("passed", results[shouldspec_file .. "::namespace::nested namespace::pass"].status)
		assert.equals("failed", results[shouldspec_file .. "::namespace::nested namespace::fail"].status)
	end)
end)
